...
Throw an error if the "requested" indices `I` are not in bounds for
the "permitted" indices `IA`. See also `checkbounds_indices(Bool, IA, I)`.
"""
checkbounds_indices(IA, I) = checkbounds_indices(Bool, IA, I) || throw_boundserror(IA, I)
